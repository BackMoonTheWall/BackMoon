...
public class CircleProgressBar extends JPanel {
	...
	public void paint(Graphics g) {
		...
		int digitalWidth = fontMetrics.stringWidth(progress/whole + "%");
		int digitalAscent = fontMetrics.getAscent();
		graphics2d.setColor(digitalColor);
		graphics2d.drawString(progress/whole+"%", getWidth() / 2 - digitalWidth / 2, getHeight() / 2 + digitalAscent / 2);
	}
